    ...
    <div class="card-table">
        <div class="table-header">
            ...
            <button class="btn btn-primary" onclick="route('form_tambah_user','popupcontent','1','true')">
             ...
             <button class="btn btn-danger" id="tombol-terhapus" onclick="route('list_user&cat=terhapus','table-user','0','false');
             $('#tombol-aktif').show(); 
             $('#tombol-terhapus').hide();
             " style="width: 160px;">
                <i class="fa-solid fa-lock"></i> User Terhapus
            </button>
            <button class="btn btn-success" id="tombol-aktif"  onclick="route('list_user','table-user','0','false');
             $('#tombol-aktif').hide(); 
             $('#tombol-terhapus').show();
